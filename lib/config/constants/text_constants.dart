abstract class TextConstant {
  static const title = 'Tago';
  static const fontFamilyBold = 'Firma_Bold';
  static const fontFamilyNormal = 'Firma_Normal';
...
forgot password
-----------------------------------------------------------------------*/
  static const enterthePhoneno = 'Enter the phone number used to create the account';
  static const enterthePassword = 'Enter the password used to create the account';
  static const updateYourProfile = 'Please complete fields to update your profile';
...
-----------------------------------------------------------------------*/
  ...
  static const noResultFound = 'No results found in Orders!';
...
-----------------------------------------------------------------------*/
  ...
  static const cartIsEmpty = 'Your Cart is empty';
...
-----------------------------------------------------------------------*/
  ...
  static const yourOrderWasPlacedSuccessfully =
      'Your order was placed successfully and will be reviewed';
  static const orderReceived = 'Order Received';
  static const orderReceivedFulfilmentCenter =
      'Your order has been received by the fulfilment center close to you';
  ...
  static const minsLeft = 'minutes left';
  static const itemsInYourOrder = 'Items in your order';
