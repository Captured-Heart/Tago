...
class _AddAddressManuallyScreenState extends ConsumerState<AddAddressManuallyScreen> {
  ...
  void runAfterBuild() {
    if (widget.addressData != null) {
      controller.addressStreetController.text = widget.addressData!.streetAddress ?? "";
      controller.addressCityController.text = widget.addressData!.city ?? "";
      controller.apartmentNoController.text = widget.addressData!.streetNumber.toString();
      controller.addressStateController.text = widget.addressData!.region ?? "";
      controller.addressPostalController.text = widget.addressData!.postal ?? "";
    }
  }
                  ...
                  if (controller.signInformKey.currentState!.validate()) {
                    ref.read(accountAddressProvider.notifier).addAddressMethod(
                      map: {
                        ...
                        AddressType.postalCode.name: controller.addressPostalController.text,
                        AddressType.metadata.name: jsonEncode(widget.addressData!.toJson())
                      },
                      context: context,
                      ref: ref,
                      onNavigation: () {
