...
final orderListByIDProvider =
    AsyncNotifierProviderFamily<GetListOfOrderByIDNotifier, List<OrderListModel>, String>(() {
...
/*------------------------------------------------------------------
 ...
 -------------------------------------------------------------------*/
class GetListOfOrderByIDNotifier extends FamilyAsyncNotifier<List<OrderListModel>, String> {
  @override
