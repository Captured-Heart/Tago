...
final orderListProvider =
    AsyncNotifierProviderFamily<GetListOfOrderNotifier, List<OrderListModel>, bool>(() {
...
/*------------------------------------------------------------------
 ...
 -------------------------------------------------------------------*/
class GetListOfOrderNotifier extends FamilyAsyncNotifier<List<OrderListModel>, bool> {
  @override
