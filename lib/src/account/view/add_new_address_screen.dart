...
class _AddNewAddressScreenState extends ConsumerState<AddNewAddressScreen> {
  ...
  Future<AddressSearchResponse> openSearchWidget(String? searchText) async {
  ...
  Widget build(BuildContext context) {
    ...
    return FullScreenLoader(
      isLoading: ref.watch(accountAddressProvider).isLoading || isLoading,
      child: Scaffold(
                    ...
                    if (widget.isEditMode == false) {
                      ...
                      ref.read(accountAddressProvider.notifier).addAddressMethod(
                          map: {
                            ...
                            AddressType.postalCode.name:
                                controller.addressPostalController.text.toTitleCase(),
                            AddressType.metadata.name:
                                addressData != null ? jsonEncode(addressData!.toJson()) : ""
                          },
                          context: context,
                          ref: ref,
                          onNavigation: () {
                      ...
                      ref.read(accountAddressProvider.notifier).editAddressMethod(
                        map: {
                          ...
                          AddressType.postalCode.name: addressPostalController.text,
                          AddressType.metadata.name:
                              addressData != null ? jsonEncode(addressData!.toJson()) : ""
                        },
                        context: context,
