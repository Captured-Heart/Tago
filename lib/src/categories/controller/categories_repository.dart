  ...
  Future<CategoriesGroupModel?> fetchCategoriesMethod() async {
    ...
    if (response.statusCode == 200) {
      ...
      final categoriesList = (decodedData['data']['categories'] as List)
          ...
          .toList();
      final dealsList =
          (decodedData['data']['deals'] as List).map((e) => DealsModel.fromJson(e)).toList();
      ...
      final categoriesGroup = CategoriesGroupModel(
          categories: categoriesList, deals: dealsList, showcaseProductTag: showcaseProduct);
...
/*------------------------------------------------------------------
 ...
 -------------------------------------------------------------------*/
  ...
  Future<List<SubCategoryModel>> fetchCategoryWithSubcategoriesByLabel(String label) async {
    final Response response = await NetworkHelper.getRequest(
